...
class TestStarQualityGrader(unittest.TestCase):
    ...
    def test_flawless_star_bullet_passes_grader(self):
        ...
        violations = validate_resume.validate(
            resume, self.style_rules, enforce_star=True
        )
    ...
    def test_qualitative_bullet_with_strong_verb_and_outcome_still_fails_without_a_metric(
        self,
    ):
    ...
    def test_qualitative_bullet_with_evidence_phrase_and_outcome_language_now_passes(
        self,
    ):
