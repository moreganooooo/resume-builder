...
_CHOICES = [
    ...
    questionary.Choice(title=_icon_title("discovery", "Check Job Posting Liveness\n"), value="liveness"),
    questionary.Separator("── Evaluation ──"),
    questionary.Choice(title=_icon_title("evaluate", "Evaluate Pending Roles\n"), value="evaluate_all"),
    ...
    questionary.Choice(title=_icon_title("build", "Write Cover Letter for Specific Role(s)\n"), value="coverletter_pick"),
    questionary.Separator("── Polish ──"),
    questionary.Choice(title=_icon_title("build", "Polish a Resume or Cover Letter with Gemini\n"), value="polish"),
