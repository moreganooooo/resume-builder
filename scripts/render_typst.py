...
def _markup_executive(
    ...
    """Typst markup for the executive template."""
    markup = [
...
def _markup_compact(
    ...
    """Typst markup for the compact template."""
    markup = [
...
def _markup_tech(
    ...
    """Typst markup for the tech template."""
    markup = [
...
def _markup_standard(
    ...
    """Typst markup for the standard (default) template."""
    markup = [
        '#set page(paper: "us-letter", margin: (x: 0.5in, y: 0.5in))',
...
def generate_typst_markup(data: Dict[str, Any], template: str = "standard") -> str:
    ...
    fields = (name, tagline, contact_line, summary, skills, experience, education)
    builders = {
        "executive": _markup_executive,
        "compact": _markup_compact,
        "tech": _markup_tech,
    }
    return builders.get(template, _markup_standard)(*fields)
