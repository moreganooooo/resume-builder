...
@click.option(
    ...
    "Indeed role search, Tesla, named-company watchlist, staffing_boards -- staffing-agency boards "
    "listed in scan_filters.yml). Repeatable. Default: all configured sources.",
)
@click.option(
    "--no-verify",
    is_flag=True,
